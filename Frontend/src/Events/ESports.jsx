    ...
    >
        ...
        <div className="bg-white flex-1 p-8 rounded-2xl shadow-2xl border border-gray-300 mb-8 lg:mb-0 max-w-lg">
          ...
          <ul className="text-gray-700 list-decimal list-inside space-y-3 text-lg leading-relaxed">
            ...
            <h1 className="text-center text-3xl font-extrabold mb-6 text-gray-800 mt-5">BGMI Rules</h1>
            <li>Matches will be played on Erangel (Squad Mode) or TDM (1v1 Mode).</li>
            <h1 className=" text-2xl font-bold mb-6 text-gray-800 mt-2">TDM Rules:</h1>
            <li>No sliding allowed.</li>
            <li>Only M416 is permitted.</li>
            <li>Stunts and grenades are strictly prohibited.</li>
            <li>Teams must have four players in squad matches.</li>
            <h1 className="text-center text-3xl font-extrabold mb-6 text-gray-800 mt-5">Free Fire Rules</h1>
            <li>Players will compete in standard Battle Royale Mode.</li>
            <li>The competition will be squad-based, with teams of four players.</li>
